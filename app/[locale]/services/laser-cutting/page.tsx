...
export async function generateMetadata({
  ...
  return {
    ...
    alternates: generateAlternates("services/laser-cutting", locale),
    openGraph: {
      title: t("title"),
      description: t("description"),
      url: getFullUrl(locale, "services/laser-cutting"),
      siteName: "MSADDI.EST",
      locale: locale,
      type: "website",
      images: [
        {
          url: getImageUrl("/images/demo/service-laser-cutting-demo.webp"),
          width: 1200,
          height: 630,
          alt: t("title"),
        },
    ...
    twitter: {
      ...
      title: t("title"),
      description: t("description"),
      images: [getImageUrl("/images/demo/service-laser-cutting-demo.webp")],
    },
  };
}
...
export default async function LaserCuttingPage({
  ...
  const serviceSchema = {
    ...
    "@type": "Service",
    "@id": getSchemaId(`${locale}/services/laser-cutting`),
    name: t("hero.title"),
    ...
    image: getImageUrl("/images/demo/service-laser-cutting-demo.webp"),
  };
