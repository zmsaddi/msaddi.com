...
export function ExpertiseSection() {
  ...
  return (
    <section className="section-padding bg-gradient-to-r from-dark-base to-metal-gray">
      <div className="container-custom">
        ...
        >
          ...
          <p className="text-responsive-lg text-light-neutral/90 max-w-3xl mx-auto">
            {t("description")}
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          {stats.map((stat, index) => (
            ...
            >
              ...
              <div className="text-light-neutral/80 text-sm">{stat.label}</div>
            </motion.div>
          ))}
        </div>
      </div>
